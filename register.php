<?php
    ...
    if(isset($_POST['register'])) {
        ...
        if($password === $cPassword) {
            ...
            $hasil = mysqli_query($db_link, "SELECT username FROM admin WHERE username = '$username'");
            if(mysqli_fetch_assoc($hasil)) {
                ...
                $push_data = mysqli_query($db_link, "INSERT INTO admin (username, nama, password) VALUES ('$username', '$nama', '$password')");
